...
function bindLongPress(card, book) {
    ...
    card.addEventListener(
        ...
        function(e){
            ...
            var targetCard=target.closest(".book-card");


            if(
                targetCard &&
                targetCard!==lastDragCard
            ){

                lastDragCard=targetCard;


                var id=targetCard.dataset.id;
    ...
    card.addEventListener(
        ...
        function(e){
            ...
            if(selecting || Date.now()<suppressClickUntil){
                e.preventDefault();
            }
